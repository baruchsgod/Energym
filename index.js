...
app.use(cors({ origin: "https://energymproject.netlify.app", credentials: true })); //testing CORS
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'https://energymproject.netlify.app');
